...
const { CartPage } = require('pages/purchase/cart')
const { LoginPage } = require('pages/authentication/login')
const { SignupPage } = require('pages/authentication/signup')
const { AccountCreatedPage } = require('pages/authentication/accountCreated')
const { CheckoutPage } = require('pages/purchase/checkout')
const { PaymentPage } = require('pages/purchase/payment')
const { PaymentDonePage } = require('pages/purchase/paymentDone')
